...
type ClozeSeed = Readonly<{ template: string; acceptedResponses: readonly string[] }>;

type PatternSeed = Readonly<{ id: string; scenario: string; notice: string; title: string; explanation: string; prompt: string; answer: string; drillPrompt: string; drillKind: DrillKind; acceptedResponses: readonly string[]; cloze?: ClozeSeed }>;
...
const VOCAB_BY_PATTERN: Record<string, VocabSet> = {
  ...
  'greet-politely': {
    ...
    items: [
      ...
      { id: 'table', imageUrl: '/images/vocab/table.jpg', alt: 'A café table with two chairs', words: { fr: 'une table', it: 'un tavolo', es: 'una mesa', pt: 'uma mesa' } },
      { id: 'coffee', imageUrl: '/images/vocab/coffee.jpg', alt: 'A cup of coffee on a saucer', words: { fr: 'un café', it: 'un caffè', es: 'un café', pt: 'um café' } },
      { id: 'door', imageUrl: '/images/vocab/door.jpg', alt: 'A shop door under an awning', words: { fr: 'une porte', it: 'una porta', es: 'una puerta', pt: 'uma porta' } },
    ],
  },
  'find-place': {
    target: 'station',
    items: [
      ...
      { id: 'museum', imageUrl: '/images/vocab/museum.jpg', alt: 'A museum with columns and steps', words: { fr: 'un musée', it: 'un museo', es: 'un museo', pt: 'um museu' } },
      { id: 'street', imageUrl: '/images/vocab/street.jpg', alt: 'A city street of shopfronts', words: { fr: 'une rue', it: 'una strada', es: 'una calle', pt: 'uma rua' } },
      { id: 'map', imageUrl: '/images/vocab/map.jpg', alt: 'A city map spread out with a compass', words: { fr: 'un plan', it: 'una mappa', es: 'un mapa', pt: 'um mapa' } },
    ],
  },
  'ask-help': {
    target: 'door',
    items: [
      { id: 'door', imageUrl: '/images/vocab/door.jpg', alt: 'A doorway with a step up to it', words: { fr: 'une entrée', it: 'un ingresso', es: 'una entrada', pt: 'uma entrada' } },
      { id: 'map', imageUrl: '/images/vocab/map.jpg', alt: 'A city map spread out with a compass', words: { fr: 'un plan', it: 'una mappa', es: 'un mapa', pt: 'um mapa' } },
      ...
      { id: 'passport', imageUrl: '/images/vocab/passport.jpg', alt: 'A passport on a desk', words: { fr: 'un passeport', it: 'un passaporto', es: 'un pasaporte', pt: 'um passaporte' } },
    ],
  },
  'pay-politely': {
    target: 'card',
    items: [
      { id: 'bill', imageUrl: '/images/vocab/bill.jpg', alt: 'A restaurant bill in a folder on a table', words: { fr: 'l’addition', it: 'il conto', es: 'la cuenta', pt: 'a conta' } },
      { id: 'card', imageUrl: '/images/vocab/card.jpg', alt: 'A card payment terminal on a table', words: { fr: 'une carte', it: 'una carta', es: 'una tarjeta', pt: 'um cartão' } },
      ...
      { id: 'wallet', imageUrl: '/images/vocab/wallet.jpg', alt: 'A wallet with cards and coins', words: { fr: 'un portefeuille', it: 'un portafoglio', es: 'una cartera', pt: 'uma carteira' } },
    ],
  },
  'ask-directions': {
    target: 'museum',
  ...
  'hotel-checkin': {
    target: 'key',
    items: [
      { id: 'hotel', imageUrl: '/images/vocab/hotel.jpg', alt: 'A hotel entrance with a luggage cart', words: { fr: 'un hôtel', it: 'un hotel', es: 'un hotel', pt: 'um hotel' } },
...
const makeConcept = (language: string, position: number, seed: PatternSeed): ConceptFixture => {
  ...
  drills: [
    ...
    ...(seed.cloze ? [{ id: `${seed.id}-cloze`, conceptId: seed.id, cefrLevel: 'B1' as const, kind: 'CLOZE' as const, prompt: seed.cloze.template, acceptedResponses: seed.cloze.acceptedResponses, recallTarget: seed.cloze.acceptedResponses[0] ?? seed.answer, contentProvenance: 'ORIGINAL' as const }] : []),
  ],
  };
};
