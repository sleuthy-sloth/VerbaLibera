...
export function composeLessonSession(course: CourseFixture, conceptId: string): readonly SessionStep[] {
  ...
  return [
    ...
    ...concept.drills.filter(drill => drill.cefrLevel === concept.cefrLevel).map(drill => ({
