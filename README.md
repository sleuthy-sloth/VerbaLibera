...
- The exercise MIX is still lopsided and mid-repair. `translate` and typed text answers remain the most common activity in every course, and only 23 of 600 practice activities ask the learner to speak — all of them Italian. Spanish has no self-assessed exercise kind either, and it joined the schemaVersion 2 player in the last flip, so for all four the gap is authoring work rather than a missing player capability. French, German, Portuguese and Spanish could carry speaking steps; none are authored yet.
