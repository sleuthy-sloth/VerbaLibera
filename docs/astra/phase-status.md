...
| 13 Pronunciation | Existing optional local transcription retained; no invented pronunciation score. Italian is the only course with speaking steps (23); the other four are schemaVersion 1 and need a player capability before content. |
