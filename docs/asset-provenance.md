...
All assets in this document are original VerbaLibera project assets. They were generated with the built-in image-generation tool, visually inspected before being placed in `public/`, and have no third-party source material, logos, mascots, or embedded text.
...
- **Selected source:** `public/brand/verbalibera-app-icon-source.png` (1254 × 1254)
- **Prompt:**
...
- **Derived files:**
  - `public/icons/verbalibera-192.png` — regular 192 × 192 PWA icon.
  - `public/icons/verbalibera-512.png` — regular 512 × 512 PWA icon.
  - `public/icons/verbalibera-maskable-512.png` — 512 × 512 maskable PWA icon. The source’s Cloud background and generous inset preserve a safe zone without transparency.
